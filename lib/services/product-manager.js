...
export default class ProductManager {
  ...
  async ensureSameForAllAttributes (variants, productTypeId, productDraft) {
    ...
    const sameForAllAttrs = this._collectSameForAllAttrs(productType)
    const violatedAttrs = this._collectViolatedAttrs(variants, sameForAllAttrs)
  ...
  _collectViolatedAttrs (variants, sameForAllAttrs) {
    return sameForAllAttrs.filter(attr => !this._isAttributeSameForAll(attr, variants))
  }

  _collectSameForAllAttrs (productType) {
