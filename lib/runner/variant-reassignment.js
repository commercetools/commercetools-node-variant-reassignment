...
export default class VariantReassignment {
  ...
  _selectMatchingProducts (productDraft, products) {
    ...
    if (products) {
      ...
      const matchingProductsBySku = this._selectMatchingProductsByVariant(products,
        productDraftSkus)
      return _.uniq(matchingProductsBySku.concat(matchingProductsBySlug))
    }
  ...
  _selectMatchingProductsByVariant (products, productDraftSkus) {
