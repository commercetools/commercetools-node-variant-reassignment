...
export default class VariantReassignment {
  ...
  async _createAndExecuteActions (productDraft, anonymizedProductDraft, backupVariants,
    ...
    await this._ensureRemoveVariantsFromMatchingProducts(backupVariants, matchingProducts)
    ...
    await this._ensureRemoveVariantsFromCtpProductToUpdate(
  ...
  _ensureRemoveVariantsFromCtpProductToUpdate () {}

  _createVariantsInCtpProductToUpdate () {}

  _ensureRemoveVariantsFromMatchingProducts () {}
