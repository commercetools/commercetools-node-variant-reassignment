  ...
  (0, _createClass3.default)(VariantReassignment, [{
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(productDrafts) {
        var _statistics$badReques;

        var productTypeNameToTypeObj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

        var badRequestSKUs, products, productDraftsForReassignment, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, productDraft, skus, _statistics$processed;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 41:
                ...
                badRequestSKUs.push.apply(badRequestSKUs, (0, _toConsumableArray3.default)(skus));
                _context.next = 46;
              ...
              case 66:
                ...
                (_statistics$badReques = this.statistics.badRequestSKUs).push.apply(_statistics$badReques, badRequestSKUs);
                return _context.abrupt('return', {
                  badRequestSKUs: badRequestSKUs,
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                this.statistics.transactionRetries++;
                _context2.next = 4;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                ...
                return _context3.abrupt('return', this._processUnfinishedTransactions(transactions, ++retryCount));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                ...
                error[constants.ERROR_CONTEXT] = 'Unrecoverable error, will delete backup custom object: ' + (0, _stringify2.default)(transactions);
                _context4.next = 7;
              ...
              case 12:
                ...
                this.statistics.badRequestErrors++;
                _context4.next = 16;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 38:
                ...
                this.logger.warn('VariantReassignment Error occurred while processing an unfinished transaction', _util2.default.inspect(_context5.t1, false, null));
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                ...
                this.logger.warn('No matching products for ' + (0, _stringify2.default)(productDraft));
              ...
              case 22:
                ...
                this.logger.error('VariantReassignment Error occurred while processing product draft', _util2.default.inspect(productDraft, false, null), _util2.default.inspect(_context6.t0, false, null));
    ...
    value: function () {
      var _ref8 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee7(productDraft, anonymizedProductDraft, backupVariants, ctpProductToUpdate, transaction, matchingProducts) {
        var _ctpProductToUpdate, productToUpdateCandidate, ctpProductTypeId, draftProductType;

        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _ctpProductToUpdate = ctpProductToUpdate;
              ...
              case 4:
                ...
                // TODO should we first check if productToUpdateCandidate exists?
              ...
              case 13:
                ...
                // debug empty ctpProductToUpdate variable issue, more info here:
                // https://github.com/commercetools/commercetools-node-variant-reassignment/issues/82
                if (!ctpProductToUpdate) this.logger.warn('Reassignment has empty ctpProductToUpdate! ' + 'Logging out original ctpProductToUpdate, matchingProducts and productToUpdateCandidate:', _util2.default.inspect(_ctpProductToUpdate, false, null), _util2.default.inspect(matchingProducts, false, null), _util2.default.inspect(productToUpdateCandidate, false, null));
        ...
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 7:
                this.statistics.anonymizedSlug.push((0, _values2.default)(productDraft.slug)[0]);
    ...
    value: function () {
      var _ref13 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee13(productDraft, matchingProducts) {
        var _this5 = this;
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _context13.next = 5;
                return _bluebird2.default.map(productsToAnonymize, function () {
                  var _ref14 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee12(product) {
                    return _regenerator2.default.wrap(function _callee12$(_context12) {
                      while (1) {
                        switch (_context12.prev = _context12.next) {
                          ...
                          case 2:
                            _this5.statistics.anonymizedSlug.push((0, _values2.default)(product.masterData.staged.slug)[0]);
    ...
    value: function () {
      var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14(anonymizedProductDraft, ctpProductToUpdate) {
        var skusToRemove;
      ...
      function _removeVariantsFromCtpProductToUpdate(_x31, _x32) {
    ...
    value: function () {
      var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(backupVariants, productDraft, ctpProductToUpdate) {
        var _this6 = this;
        ...
        return _regenerator2.default.wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 8:
                setAttrActions = _context15.sent;
              ...
              case 29:
                ...
                return _context15.abrupt('return', this.productService.updateProduct(ctpProductToUpdate, actions));
        ...
        }, _callee15, this, [[13, 17, 21, 29], [22,, 24, 28]]);
      }));

      function _createVariantsInCtpProductToUpdate(_x33, _x34, _x35) {
    ...
    value: function () {
      var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee16(backupVariants, matchingProducts) {
        var _this7 = this;
          ...
          while (1) {
            switch (_context16.prev = _context16.next) {
              case 0:
                ...
                return _context16.abrupt('return', matchingProducts);
              ...
              case 23:
                ...
                return _context16.abrupt('return', _bluebird2.default.map((0, _from2.default)(productToSkusToRemoveMap), function (_ref18) {
      ...
      function _removeVariantsFromMatchingProducts(_x36, _x37) {
